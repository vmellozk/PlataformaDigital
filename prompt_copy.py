def get_full_prompt(name):
    return (f'Não responda agora, mas vamos brincar! Você trabalha numa livraria, e recebe uma demanda de um CEO para gerar um novo livro. Você recebe a seguinte mensagem dele.'
