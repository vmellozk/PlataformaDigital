...
def process_user(user_id):
    ...
    current_position = len(tab_queue.queue) % len(positions)
        ...
        with semaphore:
            ...
            if not task_queue.empty():
                ...
                if not tab_queue.full():
                    ...
                    # Introduzir um pequeno delay antes de processar a próxima aba
                    time.sleep(2)  # Ajuste o valor conforme necessário
                else:
