...
from handling_error import click_image_if_found 
import threading
...
def continuously_check_images():
    while True:
        try:
            ...
            if found:
                print("Imagem encontrada e clique efetuado.")
        except Exception as e:
            # Se desejar, pode adicionar um print aqui para saber quando um erro não esperado acontece.
            pass  # Não faz nada se ocorrer uma exceção
        time.sleep(2)
...
if __name__ == "__main__":
    chatgpt_response('responses.txt', 'output.txt', 'tittle.txt', 'name')
