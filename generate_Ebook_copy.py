...
def generate_ebook(user_id):
    ...
    try:
        ...
        print("Respostas do ChatGPT obtidas.")

        # Ler e combinar o conteúdo dos arquivos de saída para o PDF
        combined_content = ""
        for filename in ['initial_prompt.txt', 'responses_prompt.txt', 'cover_prompt.txt', 'toc_prompt.txt', 'intro_prompt.txt', 'content_prompt.txt', 'conclusion_prompt.txt']:
